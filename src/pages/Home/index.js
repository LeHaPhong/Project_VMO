            ...
            <li className="w-270 h-270">
              <Link to="/coffe">
                <img
                  className="shadow-3xl rounded-2xl w-370 h-72"
                  alt=""
                  src="https://product.hstatic.net/1000075078/product/caramel-cm_3568a53b217f4616af28e1f7c9d38ce6_large.jpg"
                />
                <p className="font-semibold">CloudFee Creamy Caramel</p>
              </Link>
              <span>39.000 đ</span>
            </li>
            <li className="w-270 h-270">
              <Link to="/coffe">
                ...
                <p className="font-semibold">
                  CloudFee Creme Brulee Hạnh Nhân Nướng
                </p>
              </Link>
              <span>49.000 đ</span>
            </li>
            <li className="w-270 h-270">
              <Link to="/coffe">
                <img
                  className="shadow-3xl rounded-2xl w-370 h-72"
                  alt=""
                  src="https://product.hstatic.net/1000075078/product/cbf-caramel_e804caf3b9a948d2b7064879292686eb_large.jpg"
                />
                <p className="font-semibold">CloudFee Creme Brulee Caramel</p>
              </Link>
              <span>49.000 đ</span>
            </li>
            <li className="w-270 h-270">
              <Link to="/coffe">
                <img
                  className="shadow-3xl rounded-2xl w-370 h-72"
                  alt=""
                  src="https://product.hstatic.net/1000075078/product/cbf-ovaltine_5cbef7eb2fa84f6c99c2fb5ae8579226_large.jpg"
                />
                <p className="font-semibold">CloudFee Creme Brulee Ovaltine</p>
              </Link>
              <span>49.000 đ</span>
            </li>
          </ul>
